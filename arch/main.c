...
void main(void)
{
  ...
  console_init();
  puts("MauNux Boot Starting....\n");

  
  console_init();
  if (cmdline_find_option_bool("debug"))
    puts("MauNux debug mode start.\n");
  ...
  if (validate_cpu()) {
    puts("MauNux is not compatible with this CPU. ⚠️.\n");
    die();
  }
  ...
  /* Set the video mode */
  puts("Starting of video..🖥️\n")
  set_video();

  /* Do the last things and invoke protected mode */
  puts("Starting of protected mode..\n")
